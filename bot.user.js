...
function getLatestCommit() {
    window.jQuery.ajax({
            url: "https://api.github.com/repos/devdavidkarlsson/Agar.io-bot/git/refs/heads/master",
            cache: false,
            dataType: "jsonp"
        }).done(function(data) {
            ...
            $.get('https://raw.githubusercontent.com/devdavidkarlsson/Agar.io-bot/master/bot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                {
                    update("aposBot", "bot.user.js", "https://github.com/devdavidkarlsson/Agar.io-bot/blob/" + sha + "/bot.user.js/");
                }
            ...
            if (player.length > 0) {
                ...
                for (var k = 0; k < player.length; k++) {
                    ...
                    for (var i = 0; i < allPossibleThreats.length; i++) {
                        ...
                        if(enemyDistance <100 && enemydistance > 10){
                            enemyDistance -= 10;
                        }
